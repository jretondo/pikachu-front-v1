...
if (process.env.NODE_ENV === "development") {
    if (local === 1) {
        host = "http://localhost:3009/api"
        publicFiles = "http://localhost:3009/static"
    } else {
        host = "https://api-test.nekoadmin.com.ar/pikachu/api"
        publicFiles = "https://api-test.nekoadmin.com.ar/pikachu/static"
    }
} else {
    host = "https://api-prod.nekoadmin.com.ar/pikachu/api"
    publicFiles = "https://api-prod.nekoadmin.com.ar/pikachu/static"
}
